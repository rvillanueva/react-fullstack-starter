...
React Fullstack Starter combines the frontend elegance of [React Slingshot](https://github.com/coryhouse/react-slingshot) with the excellent backend plumbing of the [Angular Fullstack Generator](https://github.com/angular-fullstack/generator-angular-fullstack).
